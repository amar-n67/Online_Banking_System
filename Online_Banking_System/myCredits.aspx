<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="myCredits.aspx.cs" Inherits="Online_Banking_System.myCredits" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPH" runat="server">

    <div align="center">
        <div>
            <h3> <u> My Credit Trtansactions</u></h3>
        </div>
        <table>
            <tr>
                <td>
            ...
            <asp:GridView ID="gvMyCreditBalance" runat="server" AutoGenerateColumns="false">
                <Columns>
                ...
                <ItemTemplate>
                <asp:Label id="note" runat="server" text='<%# Eval("Notes") %>' ></asp:Label>
                </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                </Columns>
